...
# Unsplash'dan serbest kullanımlı motor fotoğrafları
motorcycle_images = {
    # Yamaha benzeri spor motorları
...
def main():
    print("🏍️ Motor fotoğrafları indiriliyor...")
    print("=" * 50)
    ...
    print("=" * 50)
    print(f"✅ {successful_downloads} fotoğraf başarıyla indirildi")
    print(f"❌ {failed_downloads} fotoğraf indirilemedi")
